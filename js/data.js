...
export const results = [
  {
    ...
    results: [
      "할 일을 정확하게 알고, 계획적으로 잘 해내는 당신은 삽 스타일입니다. 팀원들 사이에서 프로젝트 기여도가 높다는 좋은 평가를 받는 경우가 많아요. 정직히 일하는 당신 덕분에 오늘도 팀 프로젝트를 무사히 마쳤답니다!",
    ],
  },
  {
    title: "무엇보다 행동이 먼저!",
    ...
    results: [
      "누구보다 행동력이 빠른 당신은 맨손 스타일입니다. 눈앞에 해결할 도구가 보이지 않아도 어떻게든 시작해 보는 남다른 실천력으로, 팀 프로젝트에서 다양한 시도를 해볼 수 있어요. 팀원들 사이에서 당신의 별명은... 행동대장!",
    ],
  },
  {
    ...
    results: [
      "차근차근하게 사소한 부분도 놓치지 않는 당신은 모종삽 스타일입니다. 앞에 나서서 팀을 이끌진 않아도, 묵묵히 엄청난 능력을 발휘하고 있는 당신! 당신은 모르겠지만 그 노력의 결과는 언젠가 큰 성과로 나타날 것이랍니다!",
    ],
  },
  {
    ...
    results: [
      "긍정적인 마인드로 할 일을 즐겁게 하는 당신은 장난감 삽 스타일입니다. 팀원들 사이에서 분위기 메이커로 불리지 않나요? 같은 일이더라도 즐기면서 한다면 업무 효율이 쑥쑥! 앞으로 우리가 마주할 팀 프로젝트도 잘 부탁해요!",
    ],
  },
  {
